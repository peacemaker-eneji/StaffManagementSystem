...
namespace StaffManagementSystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260706104030_CalendarSources")]
    partial class CalendarSources
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StaffManagementSystem.Domain.Models.AttendanceRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StaffManagementSystem.Domain.Models.CalendarSource", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StaffManagementSystem.Domain.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StaffManagementSystem.Domain.Models.AttendanceRecord", b =>
                {
                    b.HasOne("StaffManagementSystem.Domain.Models.User", "User")
